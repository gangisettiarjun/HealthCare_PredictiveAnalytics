    ...
    <div class="container-fluid">
      <div class="row">
        <!--<div class="col-sm-3 col-md-2 sidebar">
          ...
          <h2 class="sub-header">Diabetes Report</h2>
          <div class="table-responsive">
		  
		  	  
	  <div style="width:1100px;height:500px">
<!--<script type='text/javascript' src='http://localhost/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 702px; height: 600px;'><object class='tableauViz' width='1000' height='400' style='display:none;'><param name='host_url' value='http%3A%2F%2Flocalhost%2F' /> <param name='site_root' value='' /><param name='name' value='Book2&#47;Sheet1' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showVizHome' value='n' /></object></div>      </div>
<script type='text/javascript' src='http://localhost:9876/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 702px; height: 600px;'><object class='tableauViz' width='1000' height='400' style='display:none;'><param name='host_url' value='http%3A%2F%2Flocalhost%3A9876%2F' /> <param name='site_root' value='' /><param name='name' value='Book2&#47;Sheet1' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showVizHome' value='n' /></object></div>	  
-->
<script type='text/javascript' src='http://localhost:9876/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 702px; height: 600px;'><object class='tableauViz' width='1000' height='400' style='display:none;'><param name='host_url' value='http%3A%2F%2Flocalhost%3A9876%2F' /> <param name='site_root' value='' /><param name='name' value='Book2&#47;Sheet1' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showVizHome' value='n' /></object></div>            
          </div>
        </div>
